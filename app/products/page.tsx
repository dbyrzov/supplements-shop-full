    ...
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="mb-6">
        <input
          ...
          className="w-full sm:w-1/2 px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition"
        />
      </div>
